...
/*	if(rotAngle <= 0)
    ...
    Info << "set motion to all patches" << endl;
    ...
    //NOT POSSIBLE anoymore due to Cf use. Ensure that position of the rotation point remains the same
