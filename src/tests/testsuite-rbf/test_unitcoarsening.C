...
TEST( UnitCoarsener, verify_Eigen_coarsening )
{
    ...
    RBFCoarsening rbfEigen( rbfInterpolator, true, false, false, 1e-3, 0.1, 2, 5, false );
...
TEST( UnitCoarsener, 2d_grid )
{
    ...
    std::shared_ptr<RBFInterpolation> rbfInterpolator( new RBFInterpolation( rbfFunctionEigen, false, true ) );
    RBFCoarsening rbfEigen( rbfInterpolator, true, false, false, 1e-3, 0.1, 2, 15, false );
