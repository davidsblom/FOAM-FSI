...
protected:
  ...
  virtual void SetUp()
  {
    ...
    aggressiveSpaceMapping = shared_ptr<ASMILS> ( new ASMILS( fineModel, coarseModelSolver, maxIter, nbReuse, reuseInformationStartingFromTimeIndex, singularityLimit ) );
