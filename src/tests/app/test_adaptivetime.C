...
protected:
    ...
    virtual void SetUp()
    {
        ...
        adaptiveTimeStepper = std::shared_ptr<sdc::AdaptiveTimeStepper> ( new sdc::AdaptiveTimeStepper( true, "h211b", 1.0e-3, 5 ) );
...
INSTANTIATE_TEST_CASE_P( testParameters, AdaptiveTimeSteppingTest, ::testing::Combine( Values( 2, 100, 200, 400, 800, 1600, 3200 ), Values( "SDIRK2", "SDIRK3" ) ) );
