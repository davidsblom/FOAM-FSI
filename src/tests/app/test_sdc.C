...
public:
  ...
  Piston( int nbTimeSteps, double dt, double q0, double qdot0, double As, double Ac, double omega );
  ...
  void evaluate( const Eigen::VectorXd & q, const double t, Eigen::VectorXd & f );
...
Piston::Piston( int nbTimeSteps, double dt, double q0, double qdot0, double As, double Ac, double omega )
:
...
void Piston::evaluate( const Eigen::VectorXd & q, const double t, Eigen::VectorXd & f )
{
  assert( f.rows() == 2 );
...
void Piston::solveTimeStep( const double t,
const double dt,
const Eigen::VectorXd & qold,
const Eigen::VectorXd rhs,
Eigen::VectorXd & f,
