...
namespace tubeflow {
SDCTubeFlowExplicitLinearSolidSolver::SDCTubeFlowExplicitLinearSolidSolver(int N,
    scalar nu,
    scalar rho,
    scalar h,
    scalar L,
...
void SDCTubeFlowExplicitLinearSolidSolver::evaluateFunction(const int /*k*/,
    const fsi::vector & /*q*/,
    const scalar /*t*/,
    fsi::vector &     /*f*/
    )
...
void SDCTubeFlowExplicitLinearSolidSolver::getSolution(fsi::vector & /*solution*/,
    fsi::vector &     /*f*/
    )
{}

void SDCTubeFlowExplicitLinearSolidSolver::setSolution(const fsi::vector & /*solution*/,
    const fsi::vector &         /*f*/
    ) {
    assert(false);
}
...
void SDCTubeFlowExplicitLinearSolidSolver::implicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowExplicitLinearSolidSolver::prepareImplicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowExplicitLinearSolidSolver::getVariablesInfo(std::deque<int> & dof,
