...
namespace tubeflow {
SDCTubeFlowBDFLinearizedSolidSolver::SDCTubeFlowBDFLinearizedSolidSolver(int N,
    scalar nu,
    scalar rho,
    scalar h,
    scalar L,
...
void SDCTubeFlowBDFLinearizedSolidSolver::evaluateFunction(const int /*k*/,
    const fsi::vector & /*q*/,
    const scalar /*t*/,
    fsi::vector &     /*f*/
    )
...
void SDCTubeFlowBDFLinearizedSolidSolver::getSolution(fsi::vector & /*solution*/,
    fsi::vector &         /*f*/
    )
{}

void SDCTubeFlowBDFLinearizedSolidSolver::setSolution(const fsi::vector & /*solution*/,
    const fsi::vector &         /*f*/
    ) {
    assert(false);
}
...
void SDCTubeFlowBDFLinearizedSolidSolver::implicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowBDFLinearizedSolidSolver::prepareImplicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowBDFLinearizedSolidSolver::getVariablesInfo(std::deque<int> & dof,
