...
namespace tubeflow {
SDCTubeFlowFluidSolver::SDCTubeFlowFluidSolver(scalar a0,
    scalar u0,
    scalar p0,
    scalar dt,
    scalar cmk,
...
void SDCTubeFlowFluidSolver::evaluateFunction(const int /*k*/,
    const fsi::vector & /*q*/,
    const scalar /*t*/,
    fsi::vector & f
    ) {
...
void SDCTubeFlowFluidSolver::getSolution(fsi::vector & solution,
    fsi::vector &     /*f*/
    ) {
    solution.head(N) = a;
...
void SDCTubeFlowFluidSolver::setSolution(const fsi::vector & /*solution*/,
    const fsi::vector &     /*f*/
    ) {
    assert(false);
}
...
void SDCTubeFlowFluidSolver::implicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowFluidSolver::prepareImplicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowFluidSolver::getVariablesInfo(std::deque<int> & dof,
