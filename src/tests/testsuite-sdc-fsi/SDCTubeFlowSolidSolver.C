...
namespace tubeflow {
SDCTubeFlowSolidSolver::SDCTubeFlowSolidSolver(scalar a0,
    scalar cmk,
    scalar p0,
    scalar rho,
    scalar L,
...
void SDCTubeFlowSolidSolver::evaluateFunction(const int /*k*/,
    const fsi::vector & /*q*/,
    const scalar /*t*/,
    fsi::vector &     /*f*/
    )
...
void SDCTubeFlowSolidSolver::getSolution(fsi::vector & /*solution*/,
    fsi::vector &     /*f*/
    )
{}

void SDCTubeFlowSolidSolver::setSolution(const fsi::vector & /*solution*/,
    const fsi::vector &     /*f*/
    ) {
    assert(false);
}
...
void SDCTubeFlowSolidSolver::implicitSolve(bool corrector,
    const int k,
    const int kold,
    const scalar t,
    const scalar dt,
...
void SDCTubeFlowSolidSolver::prepareImplicitSolve(bool /*corrector*/,
    const int /*k*/,
    const int /*kold*/,
    const scalar /*t*/,
    const scalar /*dt*/,
...
void SDCTubeFlowSolidSolver::getVariablesInfo(std::deque<int> & dof,
