...
class SDCInterpolateFsiExplicitSolidSolverTest : public ::testing::Test
{
    protected:
        virtual void SetUp()
        {
...
TEST_F( SDCInterpolateFsiExplicitSolidSolverTest, object )
{
    ASSERT_TRUE( true );
}

TEST_F( SDCInterpolateFsiExplicitSolidSolverTest, timeStep )
{
    sdc->solveTimeStep( 0 );
    ASSERT_TRUE( sdc->isConverged() );
}

TEST_F( SDCInterpolateFsiExplicitSolidSolverTest, run )
{
    sdc->run();
    ASSERT_TRUE( sdc->isConverged() );
}
