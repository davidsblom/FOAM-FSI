...
namespace tubeflow {
TubeFlowFluidSolver::TubeFlowFluidSolver(scalar a0,
    scalar u0,
    scalar p0,
    scalar dt,
    scalar cmk,
...
void TubeFlowFluidSolver::evaluateJacobian(const fsi::vector & x,
    const fsi::vector & a,
    const fsi::vector & un,
    const fsi::vector & pn,
    const fsi::vector & an,
 ...
 */
void TubeFlowFluidSolver::evaluateResidual(const fsi::vector & x,
    const fsi::vector & a,
    const fsi::vector & un,
    const fsi::vector & /*pn*/,
    const fsi::vector & an,
...
void TubeFlowFluidSolver::solve(const fsi::matrix & input,
    fsi::matrix & output
    ) {
    assert(input.rows() == N);
    assert(input.cols() == 1);
...
void TubeFlowFluidSolver::solve(const fsi::vector & a,
    fsi::vector & p
    ) {
    assert(init);
    assert(a.rows() == N);
