...
namespace fsi {
SpaceMapping::SpaceMapping(shared_ptr<SurrogateModel> fineModel,
...
bool SpaceMapping::isConvergence(const fsi::vector & xk,
...
void SpaceMapping::performPostProcessing(const fsi::vector & x0,
    fsi::vector & xk
    ) {
...
void SpaceMapping::performPostProcessing(const fsi::vector & y,
    const fsi::vector & x0,
    fsi::vector & xk
    ) {
