 ...
 */
void RBFCoarsening::compute(const matrix & positions,
...
void RBFCoarsening::interpolate(const matrix & values,
...
void RBFCoarsening::setNbMovingAndStaticFaceCenters(int nbMovingFaceCenters,
